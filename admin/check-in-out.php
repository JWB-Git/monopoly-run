...
<head>
    ...
    <meta name="description" content="Monopoly Run - Check In/Out">
        ...
        <div class="row mb-3">
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="update-check-in-out.php" method="post" class="text-center">
                            <label for="group">Group:</label><br />
                            <div class="form-group mx-auto">
                                <select class="form-control d-inline w-50 ml-2" name="group">
                                    <?php
                            ...
                            <input name="submit" type="submit" class="btn background-purple px-5 mb-2" value="Check In / Out">
                        </form>
                    </div>
                </div>
            </div>
