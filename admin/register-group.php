...
<head>
    ...
    <meta name="description" content="Group Register">
			...
			<div class="col-sm fill border rounded-lg shadow text-center login-container">
				...
				<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
					...
					<div class="form-group <?php echo (!empty($password_err)) ? 'has-error' : '' ?>">
						...
						<input name="password" type="password" class="form-control w-75 mx-auto" placeholder="Password" value="NclMonopoly19!">
						<span class="help-block"><?php echo $password_err; ?></span>
					</div>
					<div class="form-group <?php echo (!empty($confirm_password_err)) ? 'has-error' : ''; ?>">
						<label for="password">Confirm Password:</label>
						<input name="confirm-password" type="password" class="form-control w-75 mx-auto" placeholder="Password" value="NclMonopoly19!">
