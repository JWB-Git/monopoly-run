<!-- This is the frontend page for submitting a picture. For the backend, see upload-picture.php -->
...
<body>
	...
	<!-- iPhone detection and warning script -->
		...
		if(isIPhone){
			$('#iphone-warning').html(
				"<div class='alert alert-danger' role='alert'>" +
				  "<i class='fa fa-mobile'></i> - You appear to be using an iPhone. When uploading a picture, please select your picture from the gallery. DO NOT use the 'Take Photo' Function" +
				"</div>"
			);
		}
	</script>
