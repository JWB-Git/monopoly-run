...
<body>
	...
	<main class="container mt-3">
		<div class="card">
			<div class="card-header">OSM User Settings</div>
			<div class="card-body text-center">
				<form action="submit-user-settings.php" method="post">
					<div class="form-group">
						<label for="email">OSM Email</label>
						<input name="email" type="email" class="form-control w-75 mx-auto" placeholder="Email" value="<?php echo $section['osm_email']; ?>">
					</div>
					<div class="form-group">
					...
					<input name="submit" type="submit" class="btn background-purple px-5 mb-2" value="Submit">
				</form>
			</div>
		</div>
	</main>
